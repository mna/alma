...
return describe('math_type', function()
  ...
  it('is float for -3.567', function()
    return assert.equal('float', math_type(-3.567))
  end)
  it('is float for infinity', function()
    return assert.equal('float', math_type(1 / 0))
  end)
  it('is float for -infinity', function()
    return assert.equal('float', math_type(-1 / 0))
  end)
  return it('is float for NaN', function()
    return assert.equal('float', math_type(0 / 0))
  end)
end)
